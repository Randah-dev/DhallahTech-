...
function ChatList(t0) {
    ...
    if ($[0] !== "8a88ebc68c1bbc7b425256e3dce40624ee90fdea10293a6ab713207ff065fc8e") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8a88ebc68c1bbc7b425256e3dce40624ee90fdea10293a6ab713207ff065fc8e";
    }
    ...
    if ($[1] !== conversations || $[2] !== currentId || $[3] !== onOpen) {
        t1 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: Object.entries(conversations).map({
                "ChatList[(anonymous)()]": (t2)=>{
                    const [id, conv] = t2;
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        onClick: {
                            "ChatList[(anonymous)() > <div>.onClick]": ()=>onOpen(id)
                        }["ChatList[(anonymous)() > <div>.onClick]"],
                                ...
                                children: [
                                    ...
                                    (()=>{
                                        const unreadCount = conv.messages.filter({
                                            "ChatList[(anonymous)() > <anonymous> > conv.messages.filter()]": (msg)=>msg.status !== "read" && msg.senderId === id
                                        }["ChatList[(anonymous)() > <anonymous> > conv.messages.filter()]"]).length;
...
"[project]/src/components/chat/ChatWindow.jsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                "ChatEngine.useEffect.unsubscribe": (snapshot)=>{
                    const msgs = snapshot.docs.map({
                        "ChatEngine.useEffect.unsubscribe.msgs": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["ChatEngine.useEffect.unsubscribe.msgs"]);
                    setAllMessages(msgs);
                }
        ...
        "ChatEngine.useMemo[conversations]": ()=>{
            return allMessages.reduce({
                "ChatEngine.useMemo[conversations]": (acc, msg_1)=>{
                    ...
                    if (!acc[otherId]) {
                        acc[otherId] = {
                            name: msg_1.senderId === myId ? msg_1.receiverName : msg_1.senderName,
                            messages: []
                        };
                    }
...
_s(ChatEngine, "JphwKHV+8gDj28etAuwKEnGXWP4=");
_c = ChatEngine;
var _c;
...
function CustomerChatPage() {
    ...
    if ($[0] !== "46d762ffbfeda0d3b88d632b43dd1303179edc03b42e6cab7a759ae82c6c69b4") {
        for(let $i = 0; $i < 15; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "46d762ffbfeda0d3b88d632b43dd1303179edc03b42e6cab7a759ae82c6c69b4";
    }
...
//# sourceMappingURL=src_1caef309._.js.map