...
"[project]/src/app/customer/tech-issues/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TechIssuesPage() {
    ...
    const [viewComplaint, setViewComplaint] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const isEditing = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TechIssuesPage.useMemo[isEditing]": ()=>editingId !== null
    }["TechIssuesPage.useMemo[isEditing]"], [
        editingId
    ]);
    async function loadComplaints() {
        try {
            setLoading(true);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMyComplaints"])();
    ...
    async function handleSubmit(e) {
        ...
        try {
            if (isEditing) {
                const res_0 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateComplaint"])(editingId, {
                    title: title.trim(),
                    details: desc.trim()
                });
                console.log("رد تعديل الشكوى:", res_0.data);
                alert("تم حفظ التعديل ✅");
            } else {
                const res_1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["submitComplaint"])({
                    title: title.trim(),
                    details: desc.trim()
                });
                console.log("رد إرسال الشكوى:", res_1.data);
                alert("تم إرسال الشكوى ✅");
            }
            resetForm();
            await loadComplaints();
        } catch (err_0) {
            console.log("خطأ حفظ الشكوى:", err_0.response?.data || err_0.message);
            alert(err_0.response?.data?.message || "حدث خطأ أثناء حفظ الشكوى");
        }
    }
    ...
    function openView(c_0) {
        setViewComplaint(c_0);
    }
    ...
    async function confirmDelete() {
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteComplaint"])(confirmDeleteId);
            setConfirmDeleteId(null);
            alert("تم الحذف ✅");
            if (editingId === confirmDeleteId) resetForm();
            await loadComplaints();
        } catch (err_1) {
            alert(err_1.response?.data?.message || "حدث خطأ أثناء حذف الشكوى");
        }
    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
                                ...
                                value: desc,
                                onChange: (e_1)=>setDesc(e_1.target.value)
                            }, void 0, false, {
                                fileName: "[project]/src/app/customer/tech-issues/page.jsx",
                                lineNumber: 155,
                                columnNumber: 5
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: complaints.map((c_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "reportRow",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        type: "button",
                                        onClick: ()=>askDelete(c_1.complaintID),
                                        children: "🗑️ حذف"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/customer/tech-issues/page.jsx",
                                        lineNumber: 181,
            ...
            viewComplaint ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        viewComplaint.adminResponse ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            style: {
                                marginTop: 14,
                                padding: "12px 14px",
...
_s(TechIssuesPage, "svVHpuN6U1SYPwyNsDXrjP78+OI=");
_c = TechIssuesPage;
var _c;
__turbopack_context__.k.register(_c, "TechIssuesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_6bfe9108._.js.map