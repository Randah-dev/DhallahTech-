...
"[project]/src/app/(auth)/guest/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GuestPage() {
    ...
    if ($[0] !== "63efd991b5dde707e504f6b043f93502429d9709245f5adc9bf2467f189a654e") {
        for(let $i = 0; $i < 30; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "63efd991b5dde707e504f6b043f93502429d9709245f5adc9bf2467f189a654e";
    }
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = ({
            "GuestPage[useEffect()]": ()=>setMounted(true)
        })["GuestPage[useEffect()]"];
        t1 = [];
        $[1] = t0;
        $[2] = t1;
    ...
    if (!mounted) {
        ...
        if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
            t2 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                fileName: "[project]/src/app/(auth)/guest/page.jsx",
                lineNumber: 36,
                columnNumber: 12
            }, this);
            $[3] = t2;
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "GuestPage[handlePhoneChange]": (e)=>{
                const raw = e.target.value;
                const digitsOnly = raw.replace(/\D/g, "");
                const trimmed = digitsOnly.slice(0, 9);
                setPhone(trimmed);
            }
        })["GuestPage[handlePhoneChange]"];
        $[4] = t2;
    } else {
        t2 = $[4];
    }
    const handlePhoneChange = t2;
    let t3;
    if ($[5] !== phone || $[6] !== router) {
        t3 = ({
            "GuestPage[handleGuestContinue]": async ()=>{
                ;
                try {
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["guestAccess"])({
                        phone
                    });
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            children: [
                "يمكنك استخدام خاصية الدخول كزائر للوصول إلى خدماتنا ",
    ...
    if ($[11] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
            className: "h-11 px-2 bg-[#F2F2F2] rounded-xl border border-transparent text-sm outline-none focus:bg-white focus:border-[#5E3085] w-20 text-center",
    ...
    let t9;
    if ($[14] !== isPhoneValid) {
        t9 = isPhoneValid && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    const t12 = !isPhoneValid;
    const t13 = `bigSubmit w-full transition flex items-center justify-center ${!isPhoneValid ? "opacity-50 cursor-not-allowed grayscale" : ""}`;
    let t14;
    if ($[22] !== handleGuestContinue || $[23] !== t12 || $[24] !== t13) {
...
_s(GuestPage, "FDI9ICjem1t494ivCGH87wPIUcc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = GuestPage;
function _GuestPageImgOnError(e_0) {
...
//# sourceMappingURL=src_487a0176._.js.map