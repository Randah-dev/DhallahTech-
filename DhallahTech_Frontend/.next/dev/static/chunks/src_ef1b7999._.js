...
"[project]/src/app/(auth)/verificationCode/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VerificationCodePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "VerificationCodePage.useEffect": ()=>setMounted(true)
    }["VerificationCodePage.useEffect"], []);
    if (!mounted) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/src/app/(auth)/verificationCode/page.jsx",
        lineNumber: 20,
        columnNumber: 24
    }, this);
    ...
    const handleKeyDown = (e_0, index_0)=>{
        if (e_0.key === "Backspace") {
            if (code[index_0]) {
                const newCode_0 = [
                    ...code
                ];
    ...
    const handleVerify = async ()=>{
        ...
        try {
            ...
            let res;
            if (isGuest) {
                res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyGuest"])({
                ...
                res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyUser"])({
            ...
            const errorMsg = err.response?.data?.error || err.response?.data?.message || "رمز التحقق غير صحيح";
            if (errorMsg.includes("تبقى لك 0 محاولات") || errorMsg.includes("تجاوزت الحد المسموح") || errorMsg.includes("الرمز غير موجود أو منتهي") || errorMsg.includes("انتهت صلاحية الرمز")) {
                setShowResend(true);
            }
            alert(errorMsg);
        }
    ...
    const handleResendCode = async ()=>{
        try {
            const phone = isGuest ? localStorage.getItem("guestPhone") : isSignup ? localStorage.getItem("signupPhone") : localStorage.getItem("resetPhone");
            const res_0 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resendCode"])({
                phone
            });
            alert(`رمز جديد: ${res_0.data.data.otp}`);
            setShowResend(false);
            setCode([
                "",
                "",
            ...
            alert(err_0.response?.data?.error || err_0.response?.data?.message || "تعذر إعادة إرسال الرمز");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            className: "w-full flex items-center justify-center py-10 page-content",
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "card w-full max-w-lg overflow-hidden rounded-3xl bg-white shadow-xl",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                ...
                                onError: (e_1)=>{
                                    e_1.currentTarget.src = "https://placehold.co/300x100/ffffff/5E3085?text=Logo";
                                }
                            }, void 0, false, {
                                fileName: "[project]/src/app/(auth)/verificationCode/page.jsx",
                                lineNumber: 122,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                            className: "text-[var(--primary-purple)] text-2xl font-black mb-2",
                            children: isSignup ? "التحقق من رقم الهاتف" : isGuest ? "الدخول كزائر" : "استعادة كلمة المرور"
                        }, void 0, false, {
                            fileName: "[project]/src/app/(auth)/verificationCode/page.jsx",
                            lineNumber: 127,
                            columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: "أدخل رمز التحقق المرسل إليك"
                        }, void 0, false, {
                            fileName: "[project]/src/app/(auth)/verificationCode/page.jsx",
                            lineNumber: 130,
                            columnNumber: 13
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex flex-wrap justify-center gap-2 max-w-full px-2 mb-8",
                            dir: "ltr",
                            children: code.map((digit_0, index_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    ref: (el_0)=>inputsRef.current[index_1] = el_0,
                                    type: "text",
                                    inputMode: "numeric",
                                    maxLength: 1,
                                    value: digit_0,
                                    onChange: (e_2)=>handleChange(e_2, index_1),
                                    onKeyDown: (e_3)=>handleKeyDown(e_3, index_1),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            ...
                            disabled: !isComplete,
                            className: `bigSubmit w-full flex items-center justify-center ${!isComplete ? "opacity-50 cursor-not-allowed grayscale" : ""}`,
                            children: isSignup ? "تحقق وإنشاء الحساب" : isGuest ? "تحقق" : "تأكيد الرمز"
                        }, void 0, false, {
                            fileName: "[project]/src/app/(auth)/verificationCode/page.jsx",
                            lineNumber: 138,
                            columnNumber: 13
                        }, this),
                        showResend && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            type: "button",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex items-center justify-center gap-3 text-xs mt-6",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: isSignup ? "/login" : nextHref,
                                    className: "text-gray-400 hover:text-gray-600",
                                    children: "تخطي التحقق (للتجربة)"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(auth)/verificationCode/page.jsx",
                                    lineNumber: 147,
                                    columnNumber: 16
...
_s(VerificationCodePage, "ohGPp3ZQTRTEC5IqAxLd36+AHo0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"]
    ];
});
_c = VerificationCodePage;
var _c;
__turbopack_context__.k.register(_c, "VerificationCodePage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_ef1b7999._.js.map