...
"[project]/src/app/admin/home/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/admin/notifications").then((res)=>{
            setNotifications(res.data?.data || res.data || []);
        }).catch((err)=>console.error("خطأ في جلب إشعارات الإدارة:", err)).finally(()=>setLoading(false));
    }, []);
    const markAsRead = async (notifId)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/admin/notifications/${notifId}/read`);
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3adf3d36._.js.map