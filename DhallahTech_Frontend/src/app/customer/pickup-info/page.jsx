...
if (!itemData) {
  ...
  <div className="card space-y-6">
      ...
      <div className="p-4 bg-green-100 text-green-700 rounded-2xl text-center font-bold">
        ...
        {/* 2. بيانات المكتب (معلومات الاستلام) */}
  ...
  <div>
    ...
    <p className="text-sm text-gray-600">
      {itemData.location}
        ...
        {/* 3. خانة المحادثة (أو زر الانتقال للمحادثة) */}
        <button 
          onClick={() =>
           router.push(`/customer/chats?matchId=${matchId}&foundItemId=${itemData.foundItemId || ""}`)
          }
          className="w-full bg-white border border-gray-200 p-4 rounded-2xl flex justify-between items-center hover:bg-gray-50 transition-all"
        >
          <span className="font-bold text-gray-700">محادثة الموظف</span>
          <span className="text-[#5E3085]">💬</span>
        </button>
